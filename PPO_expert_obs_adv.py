...
class PPO_adv:
    ...
    def compute_reward(self, obs_a, next_obs_a, reward_a):
        ...
        obs_a, next_obs_a, reward_a = utils.to_torch((obs_a, next_obs_a, reward_a), self.device)

        obs_a = obs_a.reshape((1,)+obs_a.shape)
        next_obs_a = next_obs_a.reshape((1,)+next_obs_a.shape)
