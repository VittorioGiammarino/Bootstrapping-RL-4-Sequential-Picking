...
from DrQ_expert_obs_adv import DrQAgent_adv
...
class Workspace:
    def __init__(self, cfg):
        ...
        self.agent = DrQAgent_adv(self.cfg, self.image_shape, self.device)
...
@hydra.main(config_path='cfgs_DrQ_expert_obs_adv', config_name='config')
def main(cfg):
    from train_RL_DrQ_expert_obs_adv import Workspace as W
    root_dir = Path.cwd()
    workspace = W(cfg)
